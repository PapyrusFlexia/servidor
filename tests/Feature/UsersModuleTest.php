...
class UsersModuleTest extends TestCase
{
    ...
    function it_creates_a_new_user()
    {
        ...
        $this->post('/usuarios/', [
            'name' => 'Pablo',
            'email' => 'pablovegasanchez@gmail.com',
            'password' => '123456'
    ...
    function the_name_is_required_when_updating_the_user()
    {
        ...
        $this->assertDatabaseMissing('users', ['email' => 'pablovegasanchez@gmail.com']);
    }
    ...
    function the_email_must_be_valid_when_updating_the_user()
    {
        ...
        $this->assertDatabaseMissing('users', ['name' => 'Pablo Vega']);
    }
